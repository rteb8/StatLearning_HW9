...
```{r}
train_path <- "https://github.com/rteb8/StatLearning_HW9/blob/main/house-prices-advanced-regression-techniques/train.csv"
test_path <- "https://github.com/rteb8/StatLearning_HW9/blob/main/house-prices-advanced-regression-techniques/test.csv"
